...
namespace GerenciadorTarefas {
    ...
    public static class UnityConfig {
        ...
        /// <summary>
        /// Do tutorial: http://www.macoratti.net/18/06/mvc5_injdep1.htm
        /// </summary>
        public static void RegistrarComponentes() {
            var container = new UnityContainer();
            container.RegisterType<IAdministradorDAO, AdministradorDAO>();
            ...
            container.RegisterType<IDiarioDeNotaService, DiarioDeNotaService>();
